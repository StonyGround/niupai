...
public class SearchMusicRecyclerViewAdapter extends RecyclerView.Adapter<SearchMusicRecyclerViewAdapter.ViewHolder> {
    ...
    public SearchMusicRecyclerViewAdapter(Context context, List<DubSearchMusicDataInfo.ResultBean> mDatas) {
...
//        Log.e("Search-AudioUrl", audioUrl);
//        Log.e("Search-Bzaudiourl", Bzaudiourl);
//        Log.e("Search-Lraudio", Lraudio);
...
//            Glide.with(mContext).load(R.drawable.music_play).asGif().centerCrop().override(40, 46).into(holder.iv_song_start_music);
        ...
        if (mType == 1) {
            holder.tv_search_song_type.setText("经典");
        }else if (mType == 2) {
            holder.tv_search_song_type.setText("配音");
        }else if (mType == 3) {
            holder.tv_search_song_type.setText("推荐");
        }else if (mType == 4) {
            holder.tv_search_song_type.setText("英文");
        }else if (mType == 5) {
            holder.tv_search_song_type.setText("喊麦");
        }else if (mType == 6) {
            holder.tv_search_song_type.setText("广场热舞");
        }else {
