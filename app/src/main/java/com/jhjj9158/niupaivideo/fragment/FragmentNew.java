...
public class FragmentNew extends BaseDynamicFragment implements SwipeRefreshLayout.OnRefreshListener {
    ...
    private void getNewData(int begin) {
        ...
        Request.Builder requestBuilder = new Request.Builder().url(Contact.HOST + Contact
                .INDEX + "?type=2&uidx=1&begin=" + begin + "&num=" + Contact.HOME_PAGE_NUM + "&vid=" + minVid);
