...
public class FragmentWorks extends BaseDynamicFragment {
    ...
    public void getWorkData(int begin) {
        ...
        OkHttpClientManager.get(worksUrl, new OKHttpCallback<IndexBean>() {
            ...
            public void onResponse(IndexBean response) {
                ...
                if (!isLoadMore && resultBean.size() == 0) {
